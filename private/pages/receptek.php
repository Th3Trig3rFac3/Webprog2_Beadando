<?php
    ...
    $receptek = db_fetchAll('SELECT posts.id, posts.name, posts.description, posts.Post_Time, users.id, users.username FROM posts, users WHERE users.id = posts.owner_id');
